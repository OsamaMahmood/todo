 	 ...
 	 <div class=" profile">
		<div class="profile-bottom">
			...
			<div class="col-md-8 profile-text">
				...
				<tr><td>First Name</td>  
				<td>:</td>  
				<td><input type="text" name="fname" autocomplete="off" value="<?php echo $row['fname']; ?>"></td></tr>
				

				<tr><td>First Name</td>  
				<td>:</td>  
				<td><input type="text" name="lname" autocomplete="off" value="<?php echo $row['lname']; ?>"></td></tr>

				<tr>
				<td>Email</td>
				<td> :</td>
				<td><input type="email" name="email" autocomplete="off" value="<?php echo $row['email']; ?>"></a></td>
				</tr>
				<tr>
				<td>Username</td>
				<td> :</td>
				<td> <input type="text" name="username" autocomplete="off" value="<?php echo $row['username']; ?>" readonly></td>
				</tr>
				<tr>
				<td>Country </td>
				<td>:</td>
			...
			<div class="profile-btn">
                <button type="submit" name="update" class="btn bg-red">Save changes</button>
            </form>
           <div class="clearfix"></div>
			</div>
