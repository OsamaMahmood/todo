   ...
   <div class="blank">
      <?php include('additem.php'); ?>
            <center>
              ...
              <div>
                Note Heading:<br /><br /> <input type="text" autocomplete="off" name="nheading" placeholder="Note Name"><br><br>
                Discription: <br><textarea rows="15" cols="50" name="ndesc" placeholder=" Details "></textarea><br><br>
                <button class="button" name="nnote" type="submit">Save</button>
              </div>
            </form>
          </center>
        </div>
