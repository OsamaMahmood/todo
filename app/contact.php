...
<div id="wrapper">
 	...
 	<div class="blank">
<center>
    <h1>Something Not working...</h1><br />
            <h3>Do let us know...</h3><br />
            </center>
            <?php include('scomplain.php'); ?>
            <form method="post">
                <div class="col-md-12 form-group1 ">
              <textarea rows="8" name="problem" placeholder="Your Comment..." required=""></textarea>
            </div>
                <center><button class="btn btn-primary" name="scomplain" type="submit">Submit</button></center>
            </form>
